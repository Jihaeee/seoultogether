    ...
    <>
      <header className="site-header">
        <div className="site-header-inner">
          ...
          {/* 짧게 줄였다. 이전 문장(47자)은 바로 아래 필터 칩이 이미 하는 말
              — 수유실 · 경사로 · 엘리베이터 · 식당 — 을 그대로 반복하면서
              두 줄로 접혀, 브랜드 락업과 무게가 비슷해졌다. 헤더에서 태그라인이
              할 일은 목록에 없는 것을 말하는 것이다: 이 지도가 누구를 위한 건지. */}
          <p className="header-tagline">아이와 함께 걷는 길을 미리 확인하세요</p>
        </div>
      </header>
      ...
      <footer className="notice">
        <div className="notice-card">
          ...
          {/* 여섯 문장이던 것을 셋으로 줄였다. 빠진 넷은 사라진 게 아니라 각자
              쓰이는 자리로 갔다 — 직선거리는 정렬 안내문과 카드의 '직선' 라벨로,
              계단 고지는 경로 결과 카드로(WM-8), 위치 권한은 길찾기 확인 카드로.
              걷기 시작한 사람에게 페이지 맨 아래 문단은 닿지 않는다. 여기에는
              어느 화면에도 자리가 없는 것만 남긴다. */}
          <p className="notice-body">
            <b>이용 전에 확인해 주세요</b>제공된 공공데이터를 캠페인용으로 재구성한 시안입니다.
            지도 마커는 역 중심과 출입구 인근을 기준으로 찍혀 실제 위치와 다를 수 있으니, 방문 전
            현장 안내와 운영 여부를 확인해 주세요. 도보 소요시간은 유모차를 밀 때의 걸음
            속도(시속 3.5km) 기준이라 혼자 걸을 때보다 깁니다.
          </p>
        </div>
      </footer>
    </>
